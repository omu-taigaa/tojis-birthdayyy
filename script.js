...
function checkQ2(answer){
  ...
  if(a===ACCEPTED.birthdayAnswer){showMsg('q2-msg','good boy',true);revealLetter(1);}
  else{showMsg('q2-msg','bruh no loser',false);}
}
...
function checkQ4(){
  ...
  else{showMsg('q4-msg','you stupid no im not whats 9+10 21 you stupid',false);}
}

function checkQ5(answer){
  const a=String(answer||'').trim().toLowerCase();
  if(a===ACCEPTED.fossilAnswer){showMsg('q5-msg','so you know just how ancient you are hahaha',true);revealLetter(4);}
  else{showMsg('q5-msg','do u have dementia or smth..',false);}
}
...
function checkQ6(){
  ...
  if(!parsed){showMsg('q6-msg','try another format bruh its not working',false);return;}
  ...
  else{showMsg('q6-msg','how can u not know your own birthday..',false);}
}
